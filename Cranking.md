...
You can control the starter using several gerEFI firmware features:  
...
gerEFI has a separate cranking control strategy for your first couple of engine revolutions - usually, you want more fuel, different timing and simultaneous injection to start an engine. The engine would start rich, as long as it's not too rich, as long as you have a close-enough cranking timing angle.
...
In gerEFI Console, you can use command ```set cranking_rpm X``` to change this value.
</details>
