...
open source, somewhat abandoned https://github.com/gerefi/hellen-miata-NB2

[Download release firmware](https://github.com/gerefi/gerefi/releases/latest/download/gerefi_bundle_hellen72.zip)

[Snapshot firmware bundle](https://gerefi.com/build_server/gerefi_bundle_hellen72.zip)

[Issue Tracker](https://github.com/gerefi/hellen-NB2-issues)
...
[Interactive iBom rev F](https://gerefi.com/docs/ibom/hellen72_NB2-f-ibom.html)

[schematic rev E](Hardware/Hellen/hellen72_NB2-e-schematic.pdf)
[Interactive iBom rev E](https://gerefi.com/docs/ibom/hellen72_NB2-e-ibom.html)

[schematic rev D](Hardware/Hellen/hellen72-d-schematic.pdf)
[Interactive iBom rev D](https://gerefi.com/docs/ibom/hellen72-d-ibom.html)

[schematic rev C](Hardware/Hellen/hellen72-c-schematic.pdf)
[Interactive iBom rev C](https://gerefi.com/docs/ibom/hellen72-c-ibom.html)

[rev F Pinout]

[rev C-E Pinout](https://gerefi.com/docs/pinouts/hellen/helen72/)

[Forum DEVELOPMENT thread](https://gerefi.com/forum/viewtopic.php?f=4&t=1947)
...
[rev C Reference image of jumpers set for external MAP sensor on 2003 miata](https://gerefi.com/forum/download/file.php?id=7570)
