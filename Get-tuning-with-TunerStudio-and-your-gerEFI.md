# Get Tuning with TunerStudio and your gerEFI
...
* You can connect to the gerEFI board with a USB cable, or some communications stream.
...
see also [this forum thread](http://gerefi.com/forum/viewtopic.php?f=2&t=1124&p=21278)
...
Obviously tuning is a subject too complex to be dealt with exhaustively in a short wiki page. So all we can do here is give you some pointers. At this point we assume that you got the engine to run, or at least sputter using your gerEFI. All your main inputs and outputs needed to make an engine run OK are working.
