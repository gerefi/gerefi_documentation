...
Some sensors require a pullup resistor on the signal line (because they have an [open collector](https://en.wikipedia.org/wiki/Open_collector) output), but gerEFI ECU digital inputs include an internal pullup resistor that should be sufficient for any hall cam/crank position sensor.
...
#### ECUs with "Bipolar" VR inputs (microGerEFI)
...
See also https://github.com/gerefi/gerefi/wiki/Trigger#troubleshooting-with-ts-logs
