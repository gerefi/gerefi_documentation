...
**WARNING: for historical reasons microGerEFI pin numbers do not match Molex numbers on the plastic**
...
These tables provide technical information about the different types of pin found on microGerEFI.
...
| [#2, #6](https://gerefi.com/docs/pinouts/microgerefi/?connector=main&pin=6) | pgnd | Power ground        | Solidly ground directly to chassis or engine block. |
| [#17, #21](https://gerefi.com/docs/pinouts/microgerefi/?connector=main&pin=21) | sgnd | Signal ground       | Sensor ground.  ***Do not ground to engine!***
...
USB cable red wire: +5v (would not work via microGerEFI connector for versions < 0.5.0)
...
![front hall](Hardware/microGerEFI/Hardware_microGerEFI_0_1_assembled_front_hall_setup.jpg)
![front lower](Hardware/microGerEFI/Hardware_microGerEFI_0_1_assembled_front_lower.jpg)

## Extra pins

microGerEFI exposes the following pins in addition to the primary 48 pin connector:

J4:

![x](Hardware/microGerEFI/J4.png)
...
[J2 Interactive Pinout](https://gerefi.com/docs/pinouts/microgerefi/main.html)
...
![x](Hardware/microGerEFI/J8_9_10.png)

[Test point Interactive Pinout](https://gerefi.com/docs/pinouts/microgerefi/pads.html)
...
[microGerEFI photo](Hardware/microGerEFI/Hardware_microGerEFI_connector.jpg)

[microGerEFI connector PCB image](Hardware/microGerEFI/Hardware_microGerEFI_0_3_PCB_pinout.png)

[reality](Hardware/microGerEFI/microGerEFI_connectors/MRE_reality.jpg)
