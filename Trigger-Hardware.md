...
[More information about the gerEFI trigger handling software logic](Trigger)
...
This page contains information about the Variable Reluctor (VR) style sensor, commonly used for detecting angular rotation (RPM). This includes links to show how to configure the Frankenso board, as well as formulas, equations, application notes, and other such information related to how VR's work and how you get them working with gerEFI. TODO: actually, this page does not really focus on just VR

## gerEFI specific information

### General gerEFI information about the software and hardware
...
[One forum member noted their motorcycle VR goes up to 380Vp-p](https://gerefi.com/forum/viewtopic.php?p=13981#p13981).
