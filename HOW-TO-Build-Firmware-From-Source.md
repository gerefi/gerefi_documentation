# How to build the gerEFI firmware from the source files  
...
The best way to build the gerEFI firmware is using a set of tools that run best under linux,
...
```shell
git clone <https://github.com/YOUR-REPOSITORY/gerefi.git>
```

7. Run setup script  

```shell
cd /home/owner/gerefi/firmware
...
There is [a forum thread](https://gerefi.com/forum/viewtopic.php?f=5&t=9) on building the firmware, but be aware that it contains some out-of-date information.
