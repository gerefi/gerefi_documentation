...
gerEFI is a community-driven free open source project. It comes with zero warranty and zero promises including zero promises of technical support.

gerEFI has zero full time staff and most of gerEFI contributors all over the globe have day jobs and other obligations.
...
[https://gerefi.com/forum/](https://gerefi.com/forum/) is the primary free support channel. Please post your tune & log files at [gerEFI Online](Online), more on this at [Quick-Start-PDF](https://github.com/gerefi/gerefi/wiki/gerEFI-Quick-Start-PDF)

Commercial technical support starts at [the gerEFI Store](https://www.shop.gerefi.com/shop/p/details-about-gerefi-ecu-technical-support )

Please Read [How To Ask Technical Questions](https://opensource.com/life/16/10/how-ask-technical-questions)

## Q: What is Discord?

A: Discord is a group chat available via browser and phone app. After initial problem statement is defined on [https://gerefi.com/forum/](https://gerefi.com/forum/) Discord chat often comes handy for follow-up discussion. Discord registration & login see [Discord](Discord)
...
A: We have commercial technical support see https://www.shop.gerefi.com/shop/p/details-about-gerefi-ecu-technical-support
...
A: gerEFI is not specific to a particular vehicle.  The people involved own and know about a wide range of vehicles.  It's easy to forget this and use terms that may be familiar to people who mess with vehicles like yours but aren't well known in the broader audience.  Asking "What about N75?" is a much more ambiguous question than "What about N75 (boost control valves)?"  Adding the extra information (parenthetically) makes it easier for more people to understand what you are asking and help you faster.
...
A: Please use gerEFI Online to [share tunes](HOWTO-upload-tune)
...
- Please provide a picture of the gerEFI console. This tells us allot about what firmware you are using, and the status of your software. Also please include the console's border as that indicates information as well.
...
- Please tell us if you have updated your discovery firmware with the STLink tool. This is not the gerEFI firmware, but the discovery firmware.
