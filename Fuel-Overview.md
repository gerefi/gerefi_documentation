...
gerEFI could be used with MAF sensors sending out voltage (like Mazda Miata) or current (like Ford Aspire).

![Table](Fuel/Fuel_Control/table.png)

(also some content at [this forum thread](http://gerefi.com/forum/viewtopic.php?f=2&t=1124))
