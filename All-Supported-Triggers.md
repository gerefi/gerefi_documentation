...
[temporary link for Honda 12](https://github.com/gerefi/gerefi_documentation/issues/227)
...
![image](https://github.com/gerefi/gerefi/assets/48498823/d83fb6ee-abb2-4775-a570-4508863d6f2c)
...
See https://github.com/gerefi/gerefi/pull/4140
...
![image](https://github.com/gerefi/gerefi/assets/48498823/0ab0ab6e-c65f-4a41-bc7f-0334df27d67f)
...
If your have an unknown or an unsupported trigger shape, once you've confirmed that trigger events are getting into the software (see "troubleshooting" sections) you need to crank your engine while gerEFI console is connected with Engine Sniffer tab active.
...
Once preliminary shape of a new trigger is added into gerEFI firmware based on the Engine Sniffer image, second step is getting a more precise recording of the shape with exact angles. This is done with spark plugs removed and Sensor Sniffer mode set to TRIGGER. With long enough cranking a chart of trigger shape would appear on the Sensor Sniffer tab and the console log file (see out/ folder next to gerefi console binaries) would contain the angles. Please post this log file on the forum for the developers to encode the new trigger shape into the software.
...
See 'trigger decoding' in [Doxygen](http://gerefi.com/docs/html/)
