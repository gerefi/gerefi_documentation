...
In GerEFI console, set engine_type 47 loads base settings.
...
| Pin STM32 | Type             | Pin GerEFI | Pin 64 Conn | Pin 72 Conn (NB2) | Desc                      |
| --------- | ---------------- | ---------- | ----------- | ----------------- | ------------------------- |
...
Vehicle speed sensor (VSS) should be wired internally to P6. P6 is located on the backside of the board near PA8. From there it can be wired to a spare WXX spot on the GerEFI. The NB2 side pin is 3T.

**Air Conditioning**

| Desc | GerEFI Pin | NB2 Pin |
| ---- | ---------- | ------- |
| IN   | 3J         | 4F      |
| FAN  | 1O         | 2C      |
| OUT  | 1M         | 2K      |
