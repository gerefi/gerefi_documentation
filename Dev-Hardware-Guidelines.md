...
Our file repository for hardware is [here](https://github.com/gerefi/gerefi/tree/master/hardware)
For now we are developing hardware as individual functional modules. While all individual modules are in-depended from each over, the use the share the same component library which is located at [https://github.com/gerefi/kicad-libraries](https://github.com/gerefi/kicad-libraries)
...
Forum thread about this PCB found [here](http://gerefi.com/forum/viewtopic.php?f=4&t=381), also see:
...
Found in this thread [link](http://gerefi.com/forum/viewtopic.php?f=3&t=360&start=52)
...
[176122-6 ECU connector board](http://gerefi.com/forum/viewtopic.php?f=4&t=507)

[Our first ECU connector breakout board](http://gerefi.com/forum/viewtopic.php?f=4&t=3)

[Migration breakout board includes fused jumpers to move wires](http://gerefi.com/forum/viewtopic.php?f=4&t=454)

[Ignition modules A couple ignition (igniter) modules found in this thread.](https://gerefi.com//forum/viewtopic.php?f=4&t=286)

[2003 dodge Neon test mule](https://gerefi.com/forum/viewtopic.php?f=3&t=696)
